...
addon.hiddenOptions = {
	...
	["floatingCombatTextAuras"] = { prettyName = nil, description = "", type = "boolean"},
	...
	["floatingCombatTextCombatHealing"] = { prettyName = nil, description = "Display amount of healing you did to the target", type = "boolean"},
	["floatingCombatTextCombatHealingAbsorbSelf"] = { prettyName = nil, description = "Shows a message when you gain a shield.", type = "boolean"},
	["floatingCombatTextCombatHealingAbsorbTarget"] = { prettyName = nil, description = "Display amount of shield added to the target.", type = "boolean"},
	["floatingCombatTextCombatLogPeriodicSpells"] = { prettyName = nil, description = "Display damage caused by periodic effects", type = "boolean"},
	["floatingCombatTextCombatState"] = { prettyName = nil, description = "", type = "boolean"},
	["floatingCombatTextComboPoints"] = { prettyName = nil, description = "", type = "boolean"},
	["floatingCombatTextDamageReduction"] = { prettyName = nil, description = "", type = "boolean"},
	["floatingCombatTextDodgeParryMiss"] = { prettyName = nil, description = "", type = "boolean"},
	["floatingCombatTextEnergyGains"] = { prettyName = nil, description = "", type = "boolean"},
	["floatingCombatTextFloatMode"] = { prettyName = nil, description = "The combat text float mode", type = "number"},
	["floatingCombatTextFriendlyHealers"] = { prettyName = nil, description = "", type = "boolean"},
	["floatingCombatTextHonorGains"] = { prettyName = nil, description = "", type = "boolean"},
	["floatingCombatTextLowManaHealth"] = { prettyName = nil, description = "", type = "boolean"},
	["floatingCombatTextPeriodicEnergyGains"] = { prettyName = nil, description = "", type = "boolean"},
	["floatingCombatTextPetMeleeDamage"] = { prettyName = nil, description = "Display pet melee damage in the world", type = "boolean"},
	["floatingCombatTextPetSpellDamage"] = { prettyName = nil, description = "Display pet spell damage in the world", type = "boolean"},
	["floatingCombatTextReactives"] = { prettyName = nil, description = "", type = "boolean"},
	["floatingCombatTextRepChanges"] = { prettyName = nil, description = "", type = "boolean"},
	["floatingCombatTextSpellMechanics"] = { prettyName = nil, description = "", type = "boolean"},
	["floatingCombatTextSpellMechanicsOther"] = { prettyName = nil, description = "", type = "boolean"},
